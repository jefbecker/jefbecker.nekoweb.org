...
const s_filterReplacement = '[CENSURADO]'; // Change what filtered words are censored with (**** is the default)
...
const s_closedCommentsText = 'Comentários estão fechados no momento!';
...
const s_expandRepliesText = 'Mostrar resposta';
const s_leftButtonText = 'Página Anterior';
const s_rightButtonText = 'Próxima Página';
...
c_form.addEventListener('submit', function(){
    alert('Obrigado por assinar meu livro de visitas! Seu comentário está aguardando moderação. Isso pode levar alguns minutos');
    c_form.submit(); 
    return true;
}); 
...
function createComment(data) {
    ...
    if(data.Moderated == false) {
        name.innerText = 'Convidado'; // Change 'Guest' to whatever you want
    }
    ...
    if(data.Moderated == false) {
        text.innerText = 'Este comentário está aguardando moderação'; // Change this value to whatever you want
    }
...
function getDayNum(day) {
    ...
    switch (day.toLowerCase()) {
        case 'domingo': num = 0; break;
        case 'segunda-feira': num = 1; break;
        case 'terça-feira': num = 2; break;
        case 'quarta-feira': num = 3; break;
        case 'quinta-feira': num = 4; break;
        case 'sexta-feira': num = 5; break;
...
function getMonthNum(month) {
    ...
    switch (month.toLowerCase()) {
        case 'janeiro': num = 0; break;
        case 'fevereiro': num = 1; break;
        case 'março': num = 2; break;
        case 'abril': num = 3; break;
        case 'maio': num = 4; break;
        case 'junho': num = 5; break;
        case 'julho': num = 6; break;
        case 'agosto': num = 7; break;
        case 'setembro': num = 8; break;
        case 'outubro': num = 9; break;
        case 'novembro': num = 10; break;
        case 'dezembro': num = 11; break;
    }
    return num;
}
